...
const ProductDetail = () => {
    ...
    const priceFormat = new Intl.NumberFormat("id-ID").format(
        product?.price
    );
    ...
    return (
        <Layout>
            <main className={classes.wrapper}>
                ...
                <div className={classes.description}>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>WEIGHT</td>
                                <td>{description?.weight/1000 || 0} kg</td>
                            </tr>
                            <tr>
                                <td>SIZE</td>
                ...
                <ProductContent title="RELATED PRODUCTS" loading={isLoading} error={errorRequest} columns={5} products={relatedProducts} />
            </main>
        </Layout>
    );
};
